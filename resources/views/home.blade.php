<x-layouts.app title="SMK Al-Farisi Leles Garut">
    <div class="bg-[url('https://smkalfarisi.reidteam.web.id/img/TKJ/4.jpg')] bg-cover bg-center bg-black bg-opacity-50 bg-blend-multiply h-[372px]">
    ...
    <div class="w-full p-4 mx-auto max-w-7xl">
        <div class="flex flex-col gap-4 p-4 bg-gray-300 md:flex-row">
            ...
            <div class="flex flex-col gap-2">
                ...
                <p class="mt-2">Drs. Ahmad Nurhadi</p>
